...
export class LibraryTutorialPresentation {
  ...
  async inspectBookmarkLight(): Promise<boolean> {
    ...
    this.interactionState.setPhase("bookmark-inspection");
  ...
  async completeBookmarkCardization(): Promise<boolean> {
    ...
    this.interactionState.setPhase("free-library-after-bookmark");
    return true;
  }
  ...
  async attemptLibraryExit(): Promise<"allowed" | "blocked" | "book-rat-intro"> {
    ...
    this.interactionState.setPhase("book-rat-intro");
    ...
    this.interactionState.setPhase("book-rat-intro-complete");
